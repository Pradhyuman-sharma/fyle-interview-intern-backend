...
class Assignment(db.Model):
    ...
    @classmethod
    def grading(cls,_id,grade_given,principal:Principal):
        assignment = Assignment.get_by_id(_id)
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_valid(assignment.teacher_id == principal.teacher_id, 'This assignment doesnt belong to this teacher') 
        assertions.assert_valid(assignment.state != AssignmentStateEnum.GRADED, 'Assignment already graded')       
